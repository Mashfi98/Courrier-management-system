        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
              $status_arr = array("Item Accepted<br/>by Courier","Collected","Arrived At<br/>Destination","Ready to Pickup","Delivered","Picked-up","Unsuccessfull<br/>Delivery Attempt");
